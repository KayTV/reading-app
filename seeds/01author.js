...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('author').insert({
      ...
      biography: 'Allen Downey is a Professor of Computer Science at Olin College of Engineering. He has taught at Wellesley College, Colby College and U.C. Berkeley. He has a Ph.D. in Computer Science from U.C. Berkeley and Masters and Bachelors degrees from MIT.'
    }),
    knex('author').insert({
      id: 5,
      first_name: 'Bonnie',
    ...
    knex('author').insert({
      ...
      biography: 'Kyle Simpson is an Open Web Evangelist whos passionate about all things JavaScript. Hes an author, workshop trainer, tech speaker, and OSS contributor/leader.'
    })
  );
};
